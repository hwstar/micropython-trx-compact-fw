...
class Vfo:
    ...
    def _set_freq(self, freq, tx, usb):
        ...
        fconv = self.tuned_freq + cf_freq if usb else diff_freq
        if tx:
    ...
    # Initialize the VFO 
    def init(self, band_table):
        self.band_table = band_table
        self.tuned_freq = 7200000
        self.usb = False
        ...
        self._set_freq(self.tuned_freq, False, self.usb)
